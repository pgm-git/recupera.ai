-- ============================================================
-- Recupera.AI — CLEAN + CREATE Production Schema
-- Paste this ENTIRE script in Supabase SQL Editor → Run
-- It drops everything first, then creates from scratch
-- ============================================================

-- ============================================================
-- STEP 0: DROP EVERYTHING (safe for fresh or existing project)
-- ============================================================
...
DROP FUNCTION IF EXISTS public.limit_conversation_log() CASCADE;
DROP FUNCTION IF EXISTS public.backend_insert_lead CASCADE;
DROP FUNCTION IF EXISTS public.backend_update_lead_status CASCADE;
...
DROP TYPE IF EXISTS instance_status_enum CASCADE;
...
-- ============================================================
-- STEP 8: SECURITY DEFINER FUNCTIONS (backend bypass RLS)
-- ============================================================
