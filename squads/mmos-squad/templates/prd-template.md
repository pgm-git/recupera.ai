...
==============================================================================
template-id: prd-template
name: Mind Mapping Product Requirements Document
version: 1.0.0
description: Complete PRD for mind mapping project with ICP, scope, and success criteria
output-format: markdown
output-path: expansion-packs/mmos/minds/{mind_name}/viability/prd.md
usage-context: Generated by viability-assessment task after GO decision
related-tasks: viability-assessment.md
==============================================================================
-->
