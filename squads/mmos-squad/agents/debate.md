...
agent:
  ...
  customization: |
    ...
    - PATH VALIDATOR: Ensure clones exist in expansion-packs/mmos/minds/ before execution
...
security:
  code_generation:
    ...
    - "SANITIZE PATHS: Validate clone names against expansion-packs/mmos/minds/ directory"
    - "WHITELIST ONLY: Only allow access to expansion-packs/mmos/minds/ and outputs/debates/"
...
dependencies:
  ...
  data:
    - expansion-packs/mmos/minds/<mind-name>/system_prompts/ (clone system prompts)
    - expansion-packs/mmos/minds/<mind-name>/kb/ (clone knowledge bases)
