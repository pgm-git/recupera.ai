...
validation:
  ...
  failure-conditions:
    ...
    - "Unable to read expansion-packs/mmos/minds/ directory"
...
*map {slug}
    │
    ├─ Does expansion-packs/mmos/minds/{slug}/ exist?
    │   ├─ NO → GREENFIELD
...
**Logic:**
1. Check if `expansion-packs/mmos/minds/{slug}/` exists
...
2. If no web content, check `expansion-packs/mmos/minds/{slug}/sources/`
...
**Logic:**
1. Read `expansion-packs/mmos/minds/{slug}/metadata.yaml`
...
- "Unable to access expansion-packs/mmos/minds/ directory. Check permissions."
