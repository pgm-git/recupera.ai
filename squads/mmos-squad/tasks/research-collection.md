...
inputs:
  ...
  - name: prd_path
    ...
    required: true
    default: "expansion-packs/mmos/minds/{mind_name}/viability/prd.md"

  - name: viability_report_path
    type: file_path
    description: Path to viability assessment output
    required: true
    default: "expansion-packs/mmos/minds/{mind_name}/viability/viability-output.yaml"
...
outputs:
  - path: "expansion-packs/mmos/minds/{mind_name}/sources/sources_master.yaml"
    description: Master inventory of all discovered and collected sources
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/sources/{type}/"
    description: Raw downloaded data organized by type (blogs/, youtube/, pdf/, etc.)
    format: "directory"

  - path: "expansion-packs/mmos/minds/{mind_name}/docs/logs/{timestamp}-collection-report.yaml"
    description: Collection statistics and quality report (timestamped, in logs/)
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/docs/logs/{timestamp}-discovery-report.yaml"
...
node validate-log-locations.js ../../expansion-packs/mmos/minds/{mind_name}
```
...
- Comando base (ETL adiciona subdiretórios automaticamente: blogs/, youtube/, pdf/):
  ...
  node run-collection.js \
    ../../expansion-packs/mmos/minds/{mind}/sources/tier1_batch.yaml \
    ../../expansion-packs/mmos/minds/{mind}/sources \
