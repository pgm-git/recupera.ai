...
prerequisites:
  - Mind exists in expansion-packs/mmos/minds/{mind_name}/ directory
...
```bash
# Expected structure
expansion-packs/mmos/minds/{mind_name}/
...
1. Check if `expansion-packs/mmos/minds/{mind_name}/` directory exists
2. If NOT exists:
   - Display error: "⚠️ Mind '{mind_name}' not found in repository"
   - Suggest: "Available minds: [list directories in expansion-packs/mmos/minds/]"
   - STOP activation

3. Check if `system-prompt.md` exists
4. If NOT exists:
   - Display error: "⚠️ system-prompt.md not found for {mind_name}"
   - Suggest: "This mind may not be fully configured. Check expansion-packs/mmos/minds/{mind_name}/"
   - STOP activation
...
mind_path = f"expansion-packs/mmos/minds/{mind_name}"
...
loading:
  system_prompt:
    path: expansion-packs/mmos/minds/{{mind_name}}/system-prompt.md
...
Searched in: expansion-packs/mmos/minds/{mind_name}/
...
Path checked: expansion-packs/mmos/minds/{mind_name}/system-prompt.md
...
Check expansion-packs/mmos/minds/{mind_name}/system-prompt.md for issues.
```
