...
inputs:
  ...
  - name: sources_master_path
    ...
    required: true
    default: "expansion-packs/mmos/minds/{mind_name}/sources/sources_master.yaml"
...
outputs:
  - path: "expansion-packs/mmos/minds/{mind_name}/analysis/cognitive-spec.yaml"
    description: Complete DNA Mental™ 8-layer cognitive architecture
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/analysis/mind-brief.md"
    description: Executive summary of cognitive analysis findings
    format: "markdown"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/behavioral_patterns.yaml"
    description: "Layer 1: Observable behavioral patterns and decision-making"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/writing_style.yaml"
    description: "Layer 2: Linguistic patterns and communication style"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/routine_analysis.yaml"
    description: "Layer 3: Temporal patterns, routines, and habits"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/recognition_patterns.yaml"
    description: "Layer 4: Mental radars and attention filters"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/mental_models.yaml"
    description: "Layer 5: Thinking frameworks and reasoning patterns"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/values_hierarchy.yaml"
    description: "Layer 6: Core values in priority order"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/core_obsessions.yaml"
    description: "Layer 7: Deep driving questions"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/contradictions.yaml"
    description: "Layer 8: Productive paradoxes (THE GOLD LAYER)"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/cognitive_architecture.yaml"
    description: "Complete DNA Mental™ 8-layer synthesis"
    format: "yaml"

  - path: "expansion-packs/mmos/minds/{mind_name}/artifacts/personality_profile.json"
    description: "Psychometric personality profile"
    format: "json"

  - path: "expansion-packs/mmos/minds/{mind_name}/docs/LIMITATIONS.md"
