...
inputs:
  ...
  - name: quotes_file
    type: file_path
    default: "expansion-packs/mmos/minds/{mind_name}/artifacts/quotes_database.yaml"

  - name: timeline_file
    type: file_path
    default: "expansion-packs/mmos/minds/{mind_name}/artifacts/life_timeline.yaml"

  - name: behavioral_file
    type: file_path
    default: "expansion-packs/mmos/minds/{mind_name}/artifacts/behavioral_patterns.yaml"
...
outputs:
  ...
  - path: "expansion-packs/mmos/minds/{mind_name}/docs/LAYER-6-VALIDATION-REPORT.md"
