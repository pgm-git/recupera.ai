...
```python
if expansion-packs/mmos/minds/{slug}/ exists:
...
```python
metadata = load(f"expansion-packs/mmos/minds/{slug}/metadata.yaml")
...
📄 Reading metadata: expansion-packs/mmos/minds/joao_lozano/metadata.yaml
