...
outputs:
  - path: "expansion-packs/mmos/minds/{mind_name}/docs/logs/{timestamp}-phase-reexecution.yaml"
    description: Reexecution log with backup details
  - path: "expansion-packs/mmos/minds/{mind_name}/.phase-backup-{phase}-{timestamp}/"
...
case "{{phase}}" in
  research)
    test -f "expansion-packs/mmos/minds/{{mind_name}}/sources/sources_master.yaml" || echo "WARNING: Phase may not have been executed"
    ;;
  analysis)
    test -f "expansion-packs/mmos/minds/{{mind_name}}/artifacts/cognitive_architecture.yaml" || echo "WARNING: Phase may not have been executed"
    ;;
  synthesis)
    test -d "expansion-packs/mmos/minds/{{mind_name}}/kb" || echo "WARNING: Phase may not have been executed"
    ;;
  implementation)
    test -d "expansion-packs/mmos/minds/{{mind_name}}/system_prompts" || echo "WARNING: Phase may not have been executed"
    ;;
  testing)
    test -f "expansion-packs/mmos/minds/{{mind_name}}/docs/testing_protocol.md" || echo "WARNING: Phase may not have been executed"
    ;;
esac
```
...
- Rollback command: `git checkout {{tag}} -- expansion-packs/mmos/minds/{{mind_name}}`
...
case "{{phase}}" in
  research)
    files=(
      ...
      "expansion-packs/mmos/minds/{{mind_name}}/docs/logs/*-discovery*.yaml"
      "expansion-packs/mmos/minds/{{mind_name}}/docs/logs/*-collection*.yaml"
    )
    ;;
  analysis)
    files=(
      "expansion-packs/mmos/minds/{{mind_name}}/artifacts/behavioral_patterns.md"
      "expansion-packs/mmos/minds/{{mind_name}}/artifacts/writing_style.md"
      "expansion-packs/mmos/minds/{{mind_name}}/artifacts/cognitive_architecture.yaml"
...
Rollback: git checkout {{tag}} -- expansion-packs/mmos/minds/{{mind_name}}
...
```bash
git checkout {{tag}} -- expansion-packs/mmos/minds/{{mind_name}}
```
...
case "{{phase}}" in
  research)
    ...
    rm -rf expansion-packs/mmos/minds/{{mind_name}}/sources/articles/*.md
    rm -rf expansion-packs/mmos/minds/{{mind_name}}/sources/books/*.md
    # ... delete specific source files
    ;;

  analysis)
    # Delete all 8-layer artifacts
    rm -f expansion-packs/mmos/minds/{{mind_name}}/artifacts/behavioral_patterns.md
    rm -f expansion-packs/mmos/minds/{{mind_name}}/artifacts/cognitive_architecture.yaml
  ...
  synthesis)
    ...
    rm -f expansion-packs/mmos/minds/{{mind_name}}/artifacts/frameworks_synthesized.md
  ...
  implementation)
    ...
    rm -f expansion-packs/mmos/minds/{{mind_name}}/artifacts/identity_core.yaml
    # ... delete implementation outputs
    ;;

  testing)
    # Delete test protocols and validation reports
    rm -f expansion-packs/mmos/minds/{{mind_name}}/docs/testing_protocol.md
    rm -f expansion-packs/mmos/minds/{{mind_name}}/docs/logs/*-validation*.yaml
...
```yaml
# File: expansion-packs/mmos/minds/{{mind_name}}/docs/logs/{{timestamp}}-phase-reexecution.yaml
...
**Reexecution Log:**
- `expansion-packs/mmos/minds/{{mind_name}}/docs/logs/{{timestamp}}-phase-reexecution.yaml`
...
git checkout backup-{{mind_name}}-{{phase}}-{{timestamp}} -- expansion-packs/mmos/minds/{{mind_name}}
