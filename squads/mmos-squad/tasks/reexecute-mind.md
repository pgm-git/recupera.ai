...
prerequisites:
  - Mind directory exists at expansion-packs/mmos/minds/{mind_name}
...
outputs:
  - path: "expansion-packs/mmos/minds/{mind_name}/.backup-{timestamp}/"
    description: Git commit with full backup
  - path: "expansion-packs/mmos/minds/{mind_name}/"
...
test -d "expansion-packs/mmos/minds/{{mind_name}}" || echo "ERROR: Mind not found"
```
...
- Rollback command: `git checkout {{commit_hash}} -- expansion-packs/mmos/minds/{{mind_name}}`
...
git status --porcelain | grep -v "expansion-packs/mmos/minds/{{mind_name}}" || echo "Clean"
```
...
git add expansion-packs/mmos/minds/{{mind_name}}
...
Rollback: git checkout {{commit_hash}} -- expansion-packs/mmos/minds/{{mind_name}}
...
git show --name-only HEAD | grep "expansion-packs/mmos/minds/{{mind_name}}"
```
...
```bash
git checkout {{commit_hash}} -- expansion-packs/mmos/minds/{{mind_name}}
```
...
```yaml
preserve:
  - expansion-packs/mmos/minds/{{mind_name}}/sources/**
  - expansion-packs/mmos/minds/{{mind_name}}/sources/sources_master.yaml
  - expansion-packs/mmos/minds/{{mind_name}}/sources/priority_matrix.yaml

delete:
  - expansion-packs/mmos/minds/{{mind_name}}/artifacts/**
  - expansion-packs/mmos/minds/{{mind_name}}/kb/**
  - expansion-packs/mmos/minds/{{mind_name}}/system_prompts/**
  - expansion-packs/mmos/minds/{{mind_name}}/specialists/**
  - expansion-packs/mmos/minds/{{mind_name}}/docs/**
  - expansion-packs/mmos/minds/{{mind_name}}/metadata/**
```

**If preserve_sources = false:**
```yaml
delete:
  - expansion-packs/mmos/minds/{{mind_name}}/** (everything)
```
...
if [ "{{preserve_sources}}" = "true" ]; then
  ...
  rm -rf expansion-packs/mmos/minds/{{mind_name}}/artifacts
  rm -rf expansion-packs/mmos/minds/{{mind_name}}/kb
  rm -rf expansion-packs/mmos/minds/{{mind_name}}/system_prompts
  rm -rf expansion-packs/mmos/minds/{{mind_name}}/specialists
  rm -rf expansion-packs/mmos/minds/{{mind_name}}/docs
  rm -rf expansion-packs/mmos/minds/{{mind_name}}/metadata
else
  # Delete everything
  rm -rf expansion-packs/mmos/minds/{{mind_name}}
  # Recreate base directory
  mkdir -p expansion-packs/mmos/minds/{{mind_name}}
fi
```
...
tree expansion-packs/mmos/minds/{{mind_name}} -L 2
```
...
Mind directory cleaned: expansion-packs/mmos/minds/{{mind_name}}/
...
```bash
mkdir -p expansion-packs/mmos/minds/{{mind_name}}/docs/logs
{{#unless preserve_sources}}
mkdir -p expansion-packs/mmos/minds/{{mind_name}}/sources
{{/unless}}
mkdir -p expansion-packs/mmos/minds/{{mind_name}}/artifacts
mkdir -p expansion-packs/mmos/minds/{{mind_name}}/kb
mkdir -p expansion-packs/mmos/minds/{{mind_name}}/system_prompts
mkdir -p expansion-packs/mmos/minds/{{mind_name}}/metadata
```
...
```yaml
# File: expansion-packs/mmos/minds/{{mind_name}}/docs/logs/{{timestamp}}-reexecution-init.yaml
...
Update `expansion-packs/mmos/minds/catalog.md` if mind is already listed:
...
- `expansion-packs/mmos/minds/{{mind_name}}/` - Clean structure
- `expansion-packs/mmos/minds/{{mind_name}}/sources/` - Preserved if requested
- `expansion-packs/mmos/minds/{{mind_name}}/docs/logs/{{timestamp}}-reexecution-init.yaml` - Reexecution log
...
git checkout backup-{{mind_name}}-{{timestamp}} -- expansion-packs/mmos/minds/{{mind_name}}
```
