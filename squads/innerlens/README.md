...
**InnerLens Lite** is an AIOS-FULLSTACK expansion pack that provides **fast Big Five personality analysis** (<2 min) from text, WhatsApp, emails, and code. It complements [InnerLens Professional](https://github.com/private/innerlens) (the full 120-trait app) by offering quick screening for AIOS workflows.
